      ...
      <div class="row g-4 py-4">
        ...
        <div class="col-12 col-md-12 col-lg-8">
          <div class="row g-4">
            ...
            <div class="col-6 col-sm-6 col-md-3">
              <h6 class="mb-4">Online Shop</h6>
              <ul class="nav flex-column">
                <!-- list -->
                <li class="nav-item mb-2"><a href="#!" class="nav-link">Online Shop</a></li>
                ...
                <li class="nav-item mb-2"><a href="#!" class="nav-link">Online Shop Ads</a></li>
      ...
      <div class="border-top py-4">
        <div class="row align-items-center">
          <div class="col-md-6"><span class="small text-muted">© 2022 <span id="copyright"> -
              ...
              </span>Online Shop eCommerce HTML Template. All rights reserved. Powered by <a href="https://codescandy.com/">Codescandy</a>.</span></div>
          <div class="col-md-6">
