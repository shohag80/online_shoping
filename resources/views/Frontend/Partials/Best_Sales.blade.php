  ...
  <div class="container">
    ...
    <div class="table-responsive-xl pb-6">
      <div class="row row-cols-lg-4 row-cols-1 row-cols-md-2 g-4 flex-nowrap">
        <div class="col">
          <div class=" pt-8 px-6 px-xl-8 rounded" style="background:url(https://mir-s3-cdn-cf.behance.net/project_modules/fs/b5fc1e102243859.5f3245dcbf6b8.png)no-repeat; background-size: cover; height: 100%; width:100%">
            <div style="padding-top: 45%;" class="text-center">
              ...
              <a href="#!" class="btn btn-primary text-center">Shop Now <i class="bi bi-cart"></i></a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card card-product">
            <div class="card-body">
              <div class="text-center  position-relative "> <a href="./pages/shop-single.html"><img width="150px" src="https://u7.uidownload.com/vector/310/1012/vector-high-quality-milk-poster-vector-02-eps.jpg" alt="Grocery Ecommerce Template" class="mb-3 img-fluid"></a>
              ...
              <div class="d-flex justify-content-start text-center mt-3">
                <div class="text-center" data-countdown="2023/12/31 00:00:00"></div>
              </div>
            </div>
          </div>
        </div>
