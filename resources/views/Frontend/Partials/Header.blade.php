              ...
              <li><a class="dropdown-item" href="javascript:void(0)"><span class="me-2">
                    ...
                    <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_5543_19751)">
                        <path d="M0 8.5H16V12.5H0V8.5Z" fill="green" />
                        <path d="M0 0.5H16V4.5H0V0.5Z" fill="green" />
                        <path d="M0 4.5H16V8.5H0V4.5Z" fill="red" />
                      </g>
                      <defs>
        ...
        <div class="col-xxl-5 col-lg-5 d-none d-lg-block">
          ...
          <form action="{{route('Search')}}">
            <div class="input-group ">
              <input class="form-control rounded" name="search" type="search" placeholder="Search for products">
            ...
            <ul class="navbar-nav align-items-center ">
              <li class="nav-item dropdown w-100 w-lg-auto">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="./pages/index-5.html">Home 5 <span class="badge bg-light-info text-dark-info ms-1">New</span></a></li>
                </ul>
              </li>
              <li class="nav-item dropdown w-100 w-lg-auto">
                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
