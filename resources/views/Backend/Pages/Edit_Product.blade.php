  ...
  <div class="row mt-3 mx-3 mb-4">
    ...
    <div class="col-md-12">
      <div style="margin-top: 50px; margin-left: 10px;" class="text-center">
        <h1 class="mt-3"><b>Edit Product</b></h1>
        ...
        <div class="card-body mt-0 mx-5">
          ...
          <form action="{{route('Update_Product',$editProduct->id)}}" method="post" enctype="multipart/form-data">
              ...
              <div class="col">
                <div class="form-outline">
                  ...
                  <select name="category_id" style="height: 32px; width: 370px; border: 1px solid lightgray;">
                    ...
                    <option @if($editProduct->category_id==$item->id) selected @endif value="{{$item->id}}">{{$item->category_name}}</option>
                    @endforeach
                  </select>
              ...
              <div class="col">
                <div class="form-outline">
                  ...
                  <select name="brand_id" style="height: 32px; width: 370px; border: 1px solid lightgray;" aria-label="Default select example">
                    ...
                    <option @if($editProduct->brand_id==$item->id) selected @endif value="{{$item->id}}">{{$item->brand_name}}</option>
                    @endforeach
                  </select>
            ...
            <div>
              <div class="col">
                <div class="form-outline">
                  <label class="form-label" for="form9Example1">Product Id</label>
                  <input type="text" name="id" value="{{$editProduct->id}}" class="form-control" placeholder="Enter Product id" />
                </div>
              </div>
            </div>
            <div>
              <div class="col">
                <div class="form-outline">
                  ...
                  <input type="text" name="product_name" value="{{$editProduct->product_name}}" id="" class="form-control" placeholder='Enter Product Name' />
                </div>
              </div>
            </div>
            <div>
              <div class="col">
                <div class="form-outline">
                  ...
                  <input type="number" name="product_price" value="{{$editProduct->price}}" id="" class="form-control" placeholder='Enter Price Value (Taka)' />
                </div>
              </div>
            </div>
            <div>
            ...
            <div>
              <div class="col">
                <div class="form-outline">
                  ...
                  <textarea name="discription" style="border: 1px solid lightgray;" id="" cols="49" rows="5">{{$editProduct->discription}}</textarea>
                </div>
              </div>
            </div>
