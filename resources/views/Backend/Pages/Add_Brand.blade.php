...
<div class="Container">
    <div class="row mt-3 mx-3 mb-4"> <div class="col-md-12">
        ...
        <h1 class="mt-3 text-white">Create Brand</h1>
        ...
        <div class="col-md-4 justify-content-center"> </div>
            ...
            <div class="col-md-4 justify-content-center"> <div class="card card-custom pb-4"> <div
                ...
                <div>
                    <div class="col">
                        <div class="form-outline">
                            <label class="form-label" for="form9Example1">Brand Name</label>
                ...
                <div>
                    <div class="col">
                        <div class="form-outline">
                            <label class="form-label" for="form9Example1">Brand Discription</label>
                ...
                <div class="col-md-12">
                    <div class="col-md-8">
                        <a class="btn btn-info" href="{{url('/Brands')}}" type="submit">Go back</a>
                    </div>
                    <div class="col-md-4">
